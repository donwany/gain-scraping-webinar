...
# from scraper_module import collect_press_releases
...
JUBILEE_HOUSE = "https://presidency.gov.gh/press-releases/page/16"
...
with DAG(
        "dag_jubilee_scraper_v1",
        default_args=default_args,
        description="Scrape Jubilee House press releases",
